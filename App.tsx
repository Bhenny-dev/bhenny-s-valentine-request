...
import HeartWaves from './components/HeartWaves';
...
const App: React.FC = () => {
  ...
  // Memoize background hearts for stability across re-renders
  ...
  useEffect(() => {
    // Generate random suitors on mount
